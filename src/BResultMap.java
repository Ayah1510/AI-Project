...
public class BResultMap implements Initializable{
	...
	public void SetMap(){
		...
		for(int i=0;i<UIController.BCities.get(Result.Bindex).size();++i)
			vc.add(UIController.BCities.get(Result.Bindex).get(i));
