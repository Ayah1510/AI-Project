...
public class OGResultMap implements Initializable{
	...
	public void SetMap(){
		...
		for(int i=0;i<UIController.OptimalGCities.get(Result.OptimalGindex).size();++i)
			vc.add(UIController.OptimalGCities.get(Result.OptimalGindex).get(i));
