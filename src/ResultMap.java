...
public class ResultMap implements Initializable{
	...
	public void SetMap(){
		...
		for(int i=0;i<UIController.GCities.get(Result.Gindex).size();++i)
			vc.add(UIController.GCities.get(Result.Gindex).get(i));
